    ...
    for attempt in range(retries):
        try:
            ...
            if response.status_code == 200:
                ...
                # Extract author and reviewer information
                authors = []
...
def crawl_site(base_url, max_pages=10, retries=3):
    ...
    for page_data in site1_data:
        ...
        if site2_page_data:
            comparison_data.append({
                ...
                "site2_url": site2_page_data["full_url"],
                "site2_written_by": site2_page_data["written_by"],
                "site2_reviewed_by": site2_page_data["reviewed_by"],
            })
        else:
            comparison_data.append({
                "site1_url": page_data["full_url"],
                ...
                "site1_reviewed_by": page_data["reviewed_by"],
                "site2_url": site2_url,
                "site2_written_by": 'N/A',
                "site2_reviewed_by": 'N/A',
            })
...
crawled_site1_data = crawl_site(site1_url, max_pages=10)
